...
<div class=" bg-white container  h-auto  mx-auto   max-w-screen-2xl justify-center gap-8" ">
    <div class=" ">
    <h1 class="text-3xl font-bold text-center font-serif mt-8 uppercase">Flora</h1> <!-- Judul di luar flex container -->
    </div>
...
foreach ($flora as $flora) {
    echo "<a href='detail_flora.php?id={$flora['id']}' class='bg-white shadow-lg h-62 hover:shadow-xl transition-transform transform hover:scale-105'>";
    echo "<div class=''>";
    echo "<img src='../uploads/" . $flora['foto'] . "' alt='Product Image' class='w-full h-40 object-fit'>";
    echo "<h3 class='text-xl font-bold mb-1 px-3 uppercase'>" . $flora['nama'] . "</h3>";
    echo "</div>";
    echo "</a>";
}
?>
